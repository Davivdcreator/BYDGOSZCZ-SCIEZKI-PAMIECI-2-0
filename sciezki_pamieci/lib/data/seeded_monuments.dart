...
class SeededMonumentsData {
  static const List<Monument> monuments = [
    Monument(
      id: 'rzezba_luczniczki',
      name: 'Rzeźba Łuczniczki',
      description: 'Rzeźba Łuczniczki',
    ...
    Monument(
      ...
      name: 'Wioślarz "Na mecie"',
      description: 'Wioślarz "Na mecie"',
    ...
    Monument(
      id: 'zegar_z_czasem_bydgoskim',
      name: 'Zegar z czasem bydgoskim',
      description: 'Zegar z czasem bydgoskim',
    ...
    Monument(
      ...
      description: 'Przechodzący przez Rzekę',
    ...
    Monument(
      ...
      name: 'Pomnik św. Jana Nepomucena',
      description: 'Pomnik św. Jana Nepomucena',
    ...
    Monument(
      id: 'pomnik_szwalbego',
      name: 'Pomnik Szwalbego',
      description: 'Pomnik Szwalbego',
    ...
    Monument(
      ...
      name: 'Pomnik Leona Barciszewskiego',
      description: 'Pomnik Leona Barciszewskiego',
    ...
    Monument(
      ...
      name: 'Pomnik Marii Konopnickiej',
      description: 'Pomnik Marii Konopnickiej',
    ...
    Monument(
      ...
      name: 'Tańczące Fontanny',
      description: 'Tańczące Fontanny',
    ...
    Monument(
      ...
      name: 'Wielkie Krzesła na Wyspie Młyńskiej',
      description: 'Wielkie Krzesła na Wyspie Młyńskiej',
    ...
    Monument(
      ...
      name: 'Bydgoskie Autografy',
      description: 'Bydgoskie Autografy',
    ...
    Monument(
      id: 'luczniczka_nova',
      name: 'Łuczniczka Nova',
      description: 'Łuczniczka Nova',
    ...
    Monument(
      id: 'spodnie_andrzeja',
      name: 'Spodnie Andrzeja',
      description: 'Spodnie Andrzeja',
    ...
    Monument(
      id: 'apel_wiezniarek',
      name: 'Apel Więźniarek',
      description: 'Apel Więźniarek',
    ...
    Monument(
      ...
      description: 'Pomnik Walki i Męczeństwa',
    ...
    Monument(
      ...
      name: 'Pomnik Nieznanego Powstańca Wielkopolskiego',
      description: 'Pomnik Nieznanego Powstańca Wielkopolskiego',
    ...
    Monument(
      id: 'fontanna_studzienka',
      name: 'Fontanna Studzienka',
      description: 'Fontanna Studzienka',
      shortDescription: 'Stary Rynek, Bydgoszcz',
      location: LatLng(53.121963, 18.0002735),
      tier: MonumentTier.tierB,
    ...
    Monument(
      id: 'przebudzenie_elfow',
      name: 'Przebudzenie Elfów',
      description: 'Przebudzenie Elfów',
    ...
    Monument(
      ...
      name: 'Pomnik Wincentego Witosa',
      description: 'Pomnik Wincentego Witosa',
    ...
    Monument(
      ...
      name: 'Pomnik Poległych (Stary Fordon)',
      description: 'Pomnik Poległych (Stary Fordon)',
    ...
    Monument(
      ...
      name: 'Pomnik Henryka Sienkiewicza',
      description: 'Pomnik Henryka Sienkiewicza',
    ...
    Monument(
      ...
      name: 'Pomnik Ignacego Jana Paderewskiego',
      description: 'Pomnik Ignacego Jana Paderewskiego',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      description: 'Pomnik Fryderyka Chopina',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Pomnik Jana Sebastiana Bacha',
      description: 'Pomnik Jana Sebastiana Bacha',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Pomnik Claude\'a Debussy',
      description: 'Pomnik Claude\'a Debussy',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Pomnik Ludomira Różyckiego',
      description: 'Pomnik Ludomira Różyckiego',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Pomnik Stanisława Moniuszki',
      description: 'Pomnik Stanisława Moniuszki',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Pomnik Mieczysława Karłowicza',
      description: 'Pomnik Mieczysława Karłowicza',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Pomnik Antonina Dvoraka',
      description: 'Pomnik Antonina Dvoraka',
      shortDescription: 'Park Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1297597, 18.0114344),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Pomnik Karola Kurpińskiego',
      description: 'Pomnik Karola Kurpińskiego',
    ...
    Monument(
      id: 'obelisk_gen_henryka_dabrowskiego',
      name: 'Obelisk gen. Henryka Dąbrowskiego',
      description: 'Obelisk gen. Henryka Dąbrowskiego',
    ...
    Monument(
      id: 'igor_strawinski',
      name: 'Igor Strawinski',
      description: 'Igor Strawinski',
      shortDescription: 'Park im. Jana Kochanowskiego, Bydgoszcz',
      location: LatLng(53.1565425, 17.8419121),
      tier: MonumentTier.tierB,
    ...
    Monument(
      ...
      name: 'Polery na nabrzeżu Urbanyiego',
      description: 'Polery na nabrzeżu Urbanyiego',
    ...
    Monument(
      ...
      name: 'Obelisk na Placu Wolności',
      description: 'Obelisk na Placu Wolności',
    ...
    Monument(
      ...
      name: 'Kamień upamiętniający bydgoskich Żydów',
      description: 'Kamień upamiętniający bydgoskich Żydów',
    ...
    Monument(
      id: 'pomnik_wedrowca',
      name: 'Pomnik Wędrowca',
      description: 'Pomnik Wędrowca',
    ...
    Monument(
      ...
      name: 'Pomnik krasnoludków',
      description: 'Pomnik krasnoludków',
    ...
    Monument(
      ...
      name: 'Makieta dawnej Bydgoszczy',
      description: 'Makieta dawnej Bydgoszczy',
      shortDescription: 'ul. Mostowa, Bydgoszcz',
      location: LatLng(53.1235, 18.0084),
      tier: MonumentTier.tierB,
